...
<p align="center">
  <img src="docs/screenshots/chat-sql-query.png" alt="AI 直接 SQL 查你的待办" width="380" />
</p>

> 上图:在产品里问"还有几件待办没完成?"——内置助理跑 3 次 `sql_query` 直查 D1,给出"5 条总 / 2 条完成 / 还有 3 件"。
> 这是 MindBase 想做到的事:**让 AI 跟你共享同一份事实,不靠猜、不靠转述。**
...
<p align="center">
  <img src="docs/screenshots/collab-skill.png" alt="协作页 — 技能 / 指令 / MCP 三种接入" width="380" />
</p>
...
<table>
  <tr>
    ...
    <td width="33%"><img src="docs/screenshots/projects.png"  alt="项目 — 状态过滤 + 一行列表" /></td>
    <td width="33%"><img src="docs/screenshots/prompts.png"   alt="指令集 — 复用 prompt 模板" /></td>
  </tr>
  <tr>
    <td align="center"><sub>笔记 · 嵌套结构 + 封面</sub></td>
    <td align="center"><sub>项目 · 进行中 / 暂停 / 完成</sub></td>
    <td align="center"><sub>指令集 · 常用 prompt 模板</sub></td>
  </tr>
</table>
