...
核心预置 12 个应用 —— 🏠 主页 · ✅ 待办 · 📚 笔记 · 💰 记账 · 📂 项目 · 🪪 个人档 · 🤖 大模型 · 📜 指令集 · 🔑 API · 📧 邮箱 · 🌐 域名 · 🗺️ 足迹。其余 40+ 应用在 [**mindbase.me**](https://mindbase.me) 应用商店按需安装。

商店里没有的，在「设置 → 新建应用」里写下需求，自动拼出完整指令，交给 Claude Code 或 Codex，跑 `npm run deploy` 即可上线。
